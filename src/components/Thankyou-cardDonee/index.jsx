                ...
                <div className="thankyou-content">
                    ...
                    <div className="thankyou-right-flex">
                        <div className="thankyou-div">
                            ...
                            <p className="blue-text thankyou-para">Our Team will review your application and let you know about the result within approximately 20 days.
                            </p>
                        </div>
                        <div className="proceed-btn">
                            <Link to="/LandingPage"><button className="btn btn-primary">Proceed to the Home page</button></Link>
                        </div>
                    </div>
                </div>
            </div>
