...
function DoneeProfile({ key }) {
    ...
    const currentDonee = useRef(
        donees.find(donee => donee.userId === parseInt(params.doneeid)),
    );
            ...
            <div className="container">
                <div className="display-profile">
                    <div className="fullname">
                        <h1>{currentDonee.current.fullName}</h1>
                    </div>
                    ...
                    <div className="story-div">
                        <h1 className="donee-name-story">{currentDonee.current.fullName}'s story</h1>
                    </div>
