...
function DoneeProfile() {
    return (
        <div>This is the donee profile page</div>
=======
                ...
                <div className="display-profile">
                    ...
                    <div className="flex-display">
                        <div className="display-image">
                            <img src={currentDonee.current.imageLink} alt={currentDonee.current.firstName} /></div>
                    ...
                    <div className="story-div">
                        <h1 className="donee-name-story">{currentDonee.current.firstName}{' '}{currentDonee.current.lastName}'s story</h1>
                    </div>
                    {/*{currentDonee.current.firstName}, age 25, is single and has one daughter. She lives at her parent's house.</p>
                    <p>
                    ...
                    <p>
                        {currentDonee.current.firstName} needs a laptop to complete her training software development at freecode camp. she dreams of improving the conditions in her home. */}
                    <p>{currentDonee.current.reasonForApplication}</p>
                </div>
            </div>
        </DefaultLayout>
>>>>>>> c6235b20667bce17d90e85719995107eeecb829e
    );
}
